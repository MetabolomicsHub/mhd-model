from mhd_model.model.definitions import MHD_MODEL_V1_0_DEFAULT_SCHEMA_NAME
...
MHD_BASE_VALIDATION_V1_0.cv_nodes = [
    CvNodeValidation(
...
MHD_BASE_VALIDATION_V1_0.cv_nodes.sort(key=lambda x: x.node_type)
