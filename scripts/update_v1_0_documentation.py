...
from mhd_model.model.v1_0.dataset.validation.profile.definition import (
    CvNodeValidation,
    CvTermValidation,
    MhDatasetValidation,
...
def update_v1_0_documentation():
    ...
    for profile, target_file_name, profile_name in [
        ...
        (MHD_BASE_VALIDATION_V1_0, "mhd-base-nodes.md", "MHD Base Profile"),
    ]:
