...
from mhd_model.model.definitions import MHD_MODEL_V1_0_MS_PROFILE_NAME
...
MHD_MS_PROFILE_V1_0.mhd_nodes.sort(key=lambda x: x.node_type)

MHD_MS_PROFILE_V1_0.cv_nodes.sort(key=lambda x: x.node_type)


def validate_model():
    unique_ids = {}
    invalid_names = {}
    for node in MHD_MS_PROFILE_V1_0.mhd_nodes:
