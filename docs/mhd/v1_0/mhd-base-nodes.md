...
Basic analytical assay node representing an experimental measurement procedure. </br></br>Assay node is optional in the  MHD Base Profile. <code>Minimum: 0, Maximum: N (unbounded) </code>
