from mhd_model.model.definitions import MHD_MODEL_V1_0_LEGACY_PROFILE_NAME
...
MHD_LEGACY_PROFILE_V1_0 = MhDatasetValidation(schema=MHD_MODEL_V1_0_LEGACY_PROFILE_NAME)

MHD_LEGACY_PROFILE_V1_0.mhd_nodes = [
    NodeValidation(
        node_type="assay",
        min=0,
        validations=[
...
MHD_LEGACY_PROFILE_V1_0.cv_nodes = [
    CvNodeValidation(
...
MHD_LEGACY_PROFILE_V1_0.mhd_nodes.sort(key=lambda x: x.node_type)

MHD_LEGACY_PROFILE_V1_0.cv_nodes.sort(key=lambda x: x.node_type)
