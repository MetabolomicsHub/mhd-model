...
Any MHD object reference defined in other MHD common data model file.<br>Node object with the specified id_ must be already defined in referenced dataset mhd_identifier. </br></br>Referenced Object node is optional in the  MHD MS Profile. <code>Minimum: 0, Maximum: N (unbounded) </code>
