...
|-----------|-----------|------------|------------|
|characteristic-definition|1|characteristic_type_ref.name|[NCIT, NCIT:C14250, Organism]|
...
Any intermediate or product resulting from metabolism.<br>The term 'metabolite' subsumes the classes commonly known as primary<br>and secondary metabolites. [CHEBI, CHEBI:25212, metabolite] </br></br>Metabolite node is optional in the  MHD Legacy Profile. <code>Minimum: 0, Maximum: N (unbounded) </code>
...
|**raw_data_file_refs**|optional|<code>*list[MhdObjectId]*<code>|List of raw data file object IDs produced by the sample run<br>Target node type: <code>**raw-data-file**</code><br>Validation Rule:<br> <code>Target node type: <code>**raw-data-file**</code></code>|
...
|**protocol_refs**|optional|<code>*list[MhdObjectId]*<code>|List of protocol object IDs used in the study<br>Target node type: <code>**protocol**</code>|
